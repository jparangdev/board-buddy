...
* [P2] 닉네임#discriminator 검색 API (초대용)
...
| 기능 | Method | Endpoint |
| :--- | :--- | :--- |
| **로그인** | `GET` | `/api/v1/auth/naver` |
| **모임생성** | `POST` | `/api/v1/groups` |
| **기록저장** | `POST` | `/api/v1/groups/{id}/sessions` |
| **랭킹조회** | `GET` | `/api/v1/groups/{id}/rankings` |
| **내역조회** | `GET` | `/api/v1/users/me/history` |
